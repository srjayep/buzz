...
Gem::Specification.new do |s|
  ...
  s.require_paths = ["lib"]
  s.authors = ["George McIntosh", "Jimmi Dyson"]
  s.date = "2014-06-27"
  ...
  s.files = [
    ...
    "buzz.gemspec",
    "conf/.buzz",
    "features/activation_key_api.feature",
    "features/channel_api.feature",
    "features/fixtures/vcr_cassettes/delete_system.yml",
    "features/fixtures/vcr_cassettes/list_activation_keys.yml",
